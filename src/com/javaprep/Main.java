...
import com.javaprep.object_oriented_design.abstraction.AbstractClassExample;
import com.javaprep.object_oriented_design.abstraction.InterfaceAndAbstractClassExample;
...
public class Main {
   ...
   public static void main(String[] args) {
       //AbstractClassExample ae = new AbstractClassExample();
       //ae.execute();

       InterfaceAndAbstractClassExample ia = new InterfaceAndAbstractClassExample();
       ia.execute();
   }
}
